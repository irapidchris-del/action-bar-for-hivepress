...
( function( $ ) {
	...
	$( function() {
		...
		$( '[name^="hp_action_bar_guest_items"],[name^="hp_action_bar_user_items"],[name^="hp_action_bar_vendor_items"]' ).closest( '[data-component=repeater]' ).each( function() {
			var repeater = $( this ),
				applyCap = function() {
