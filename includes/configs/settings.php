				...
				'display'    => [
					...
					'fields'      => [
						...
						'action_bar_enable_badge'      => [
							...
							'caption'     => esc_html__( 'Show the unread message count', 'action-bar-for-hivepress' ),
							'description' => esc_html__( 'Displays the unread count from the Messages extension on Account and Messages items.', 'action-bar-for-hivepress' ),
							'type'        => 'checkbox',
							'default'     => true,
							'_order'      => 40,
						],
